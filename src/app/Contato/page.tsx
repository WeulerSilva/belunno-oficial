    ...
    return (
        <>
            ...
            <section className="w-screen h-full bg-white flex justify-center items-center flex-col text-gray-700">
                <div className="w-[90%] h-full flex flex-col justify-start items-start lg:mt-4">
                    <div className="w-full h-full flex justify-start items-start mt-4 flex-col lg:items-center 
                        ...
                        <h2 className="text-xl font-bold text-vermelho mt-4 md:text-2xl xl:mt-0 xl:mb-8 xl:text-4xl">Dúvidas Frequentes"</h2>
