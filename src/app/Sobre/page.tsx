    ...
    return (
        <>
            <section className="w-screen h-full bg-gradient-to-r from-[#e30a16] to-[#9a140f] flex justify-center items-center flex-col md:h-[400px] md:flex-row">
                ...
                mt-4 md:w-[40%]">
                        <h2 className="text-xl font-bold md:text-2xl xl:text-4xl">Nossa História e Compromisso</h2>
                        <p className="text-base md:text-lg text-justify xl:text-2xl">A Belunno é sinônimo de tradição e qualidade no mercado de
                    ...
                    <div className="w-[100%] h-[300px] flex justify-end items-center md:h-full md:w-[40%]">
            ...
            <div className="w-screen h-[260px] bg-white flex justify-center items-center text-gray-800 font-semibold md:items-start md:h-[250px]">
                <div className="w-[90%] h-full flex justify-center items-start pt-2 flex-col space-y-4
                    md:space-y-0 md:justify-between md:pt-10 md:flex-row lg:w-[80%]">
                    <div className="flex flex-col md:w-[40%] lg:w-[30%]">
                        <h2 className="text-vermelho text-xl font-bold md:text-2xl xl:text-4xl">Missão:</h2>
                        <p className="text-base text-justify md:text-[14px] xl:text-xl">Proporcionar momentos especiais com
                    ...
                    <div className="flex flex-col md:w-[40%] lg:w-[30%]">
                        ...
                        <p className="text-base text-justify md:text-[14px] xl:text-xl">Qualidade, Tradição, Compromisso com
            ...
            <div className="w-screen h-full bg-white text-black flex justify-center items-center py-4 lg:py-0">
                ...
                lg:w-[80%] lg:h-[100px] lg:flex-row">
                    <h2 className="text-vermelho text-xl font-bold text-center md:text-2xl lg:text-base xl:text-2xl 2xl:text-3xl">
