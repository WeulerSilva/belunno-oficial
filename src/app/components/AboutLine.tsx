...
export const AboutLine = ({ reverse, width, heigth, text, year, color }: Props) => {
    return (
        <div className={`${width} h-[200px] flex justify-start items-end absolute ${heigth} md:h-[250px]`}>
            ...
            <div className={`min-w-[150px] w-[130px] h-full flex ${reverse ? "flex-col-reverse lg:pb-14" : "flex-col pt-8 lg:pt-10"} md:min-w-[110px] lg:min-w-[150px]`}>
